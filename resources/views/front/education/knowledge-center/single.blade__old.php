...
@section('content')
    ...
    @include(FRONT.'.education.Html.page-header', ['title'=>$post->title])
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 main-articles order-1 order-md-2">
                        ...
                        <header>
                            <div class="row align-items-center">
                                ...
                                <div class="col-9 col-md-10">
                                    <div class="category">
                                        <a href="{{CustomRoute('education.static.knowledge-center')}}">{{$post->postMorph->constant->trans_name}}</a>
                                    </div>
                                    <h2>{{$post->title}}</h2>
                                </div>
                            </div>
                    ...
                    <div class="articel-author d-none">
                        <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                            ...
                            <div class="col-9 col-md-10">
                                <div class="d-flex justify-content-between align-items-end">
                                    <div>
                                        <h4>{!! __('education.Posted By Bakkah Inc') !!}.</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
