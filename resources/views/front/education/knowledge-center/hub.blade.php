...
a:hover {
    ...
    @include(FRONT.'.education.Html.page-header', ['title'=>__('education.Knowledge Hub')])
                ...
                <div class="col-md-6 col-lg-8 mb-4">
                  @foreach($posts as $post)
                    <article class="blog-card blog-card--featured bg-light">
                        <figure>
                            {{-- <a href="#">
                                <img class="w-100" src="https://placehold.it/500x400" alt="...">
                            </a> --}}
                  ...
                  @endforeach
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="widget card box-shadow text-center submit-paper-box h-100">
                            <div class="card-body">
                                <h2>{{__('education.READY TO SUBMIT PAPERS?')}}</h2>
                                <h3>{{__('education.Write with us now')}}</h3>
                                <p>{{__('education.All full paper submissions')}}</p>
                                <a href="mailto:contactus@bakkah.net.sa?subject={{__('education.app_title')}} Happy to publish my article&amp;body=Kindly, find the attached article file."
                                    target="_blank" class="btn btn-light boldfont px-4 main-color">{{__('education.Submit Now')}}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <aside class="blog-card blog-card--one-third h-100 bg-primary d-flex justify-content-center text-center align-items-center p-4">
                            <div>
                                <h3 style="font-size: 3em;"><a href="{{route('education.static.reports.single', $report->slug)}}" class="text-white">{{$report->trans_title}}</a></h3>
                                <a href="{{route('education.static.reports.single', $report->slug)}}" class=" btn bg-secondary text-white mt-3 cta--primary">{{__('education.Explore the Report')}}</a>
                            </div>
                        </aside>
                    </div>
                    @break
