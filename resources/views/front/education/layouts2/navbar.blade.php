                ...
                <li id="cart" class="nav-item dropdown">
                    <a  class="nav-link dropdown-toggle cart-item" href="{{route('education.cart')}}">
                        <div class="cart-wrapper">
                            ...
                            <span class="cart-count" v-if="carts.length != 0" v-html="carts.length"></span>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right cart-items-wrapper" aria-labelledby="navbarDropdown">
                        <div class="items-wrapper">
                            <div v-for="cart in carts">
                                <div class="p-3">
                                    <a :href="'/sessions/'+cart.course.slug" class="d-flex align-items-start">
                                        <div class="course-image">
                                            <img :src="`{{env('APP_URL')}}{{env('LIVE_ASSET')}}upload/thumb300/${cart.course.upload.file}`" alt="" width="100" height="100">
                                        </div>
                                        <div class="shopping-item">
                                            <div class="course-title">
                                                @if(app()->getLocale() == 'en')
