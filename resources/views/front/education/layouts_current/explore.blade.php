<div class="explore-mega-menu">
    ...
    <button class="btn btn-secondary dropdown-toggle mx-4 d-none d-xl-block" type="button" id="ExploreMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{__('education.explore')}}</button>
            ...
            <div class="dropdown-menu" aria-labelledby="ExploreMenu">
                @if($agent->isDesktop())
                    @foreach($course_menus as $course_menu)
                        <button class="dropdown-item {{$loop->index==0?'active':''}}">
