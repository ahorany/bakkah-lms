                                ...
                                <div class="col-12 col-md-4 col-lg-3 my-2 p-4">
                                    <div class="card p-4" style="width: 100%; border-radius: 10px; border: 1px solid #f2f2f2">
                                        ...
                                        <div class="card-body text-center p-0">
                                            <h3 class="card-title mb-2" style="font-weight: 700;float: none !important;"><a style="color: #000;" href="{{CustomRoute('user.course_details',$course->id)}}">{{$course->trans_title  . ($course->training_option ?  '-' . $course->training_option->trans_name : '') }}</a></h3>
