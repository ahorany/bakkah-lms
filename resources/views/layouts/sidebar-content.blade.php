                           ...
                           @foreach($section->contents as $k => $c)
                              ...
                              <li class="nav-item {{  $c->id == $content->id ? 'active' : ''  }}">
                                 <a
                                    ...
                                    href="#" class="nav-link gray-icon" onclick="pupupPay(event,'{!! PAY_COURSE_BAKKAH_URL . $course->ref_id !!}')"
                                    @else
                                    href="#" class="nav-link gray-icon" onclick="return false"
                                     @endif
                                 >
                                    <span class="d-flex">
                                        <span>
                                            <img style="filter: opacity(0.7);margin-right: 5px;" width="28.126" height="28.127" src="{{CustomAsset('icons/'.$c->post_type.'.svg')}}" alt="{{$c->title}}">
                                        </span>
                                        <span>{{$c->title}}</span>
                                    </span>
                                 </a>
