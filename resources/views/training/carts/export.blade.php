                ...
                @foreach($cart->cartFeatures as $cartFeature)
                    <tr>
                        ...
                        @elseif($cartFeature->trainingOptionFeature->feature->id == 3)
                            ...
                            <td>Take2 Exam</td>
                            <td>Take2 Exam</td>
                        @elseif($cartFeature->trainingOptionFeature->feature->id == 4 && !empty($cart->course->xero_exam_code_practitioner))
                            {{-- Exam Voucher --}}
                            <td>{{$cart->course->xero_exam_code_practitioner??null}}</td>
                            <td>Practitioner Exam Voucher</td>
                        @else
                            <td></td>
                            <td></td>
                        @endif
