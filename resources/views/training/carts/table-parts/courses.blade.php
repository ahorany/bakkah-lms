        ...
        <li style="border-bottom: 19x solid #dddcdc">
            ...
            <span style="color: #999; font-size: 12px;">
                ...
                @if(!is_null($cart->group_invoice_id))
                    ...
                    <span class="badge badge-secondary">MID: {{$cart->master_id??null}}</span>
                @endif
                        ...
                        <div class="d-flex justify-content-between d-block">
                            <div>
                                ...
                                @if(!is_null($cart->trainingOption->lms_course_id??0))
                                    @if((auth()->user()->id==1 || auth()->user()->id==2 || auth()->user()->id==3 || auth()->user()->id==3178 || auth()->user()->id==5337 || auth()->user()->id==6174 || auth()->user()->id==13094))
