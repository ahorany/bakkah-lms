      ...
      <tr data-id="{{$post->id}}">
        ...
        <td class="px-1">
            ...
            <div class="progress">
              ...
              <div style="float:right;"><a href="{{route('training.progressDetails',['user_id'=>$user[0]->id,'course_id'=>$post->id])}}" class="btn-sm outline"><span class="href">{{__('admin.details')}}</span></a></div>
        </td>
        {{-- <td class="px-1">
