<style>
    ...
    {{-- @dd($user[0]->id) --}}
    <form id="post-search" class="mb-4" method="get" action="{{route('training.usersReportTest',['id'=>$user[0]->id??null,'course_id'=>$course[0]->id??null])}}">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        {!!Builder::Input('test', 'test',request()->test??null,['col'=>'col-md-6'])!!}
                        {!!Builder::Select('result', 'result', $results, request()->result??null, ['col'=>'col-md-6', 'model_title'=>'trans_name',])!!}
                        <div class="col-md-12">
