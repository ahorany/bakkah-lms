                        ...
                        <tr>
                            ...
                            <td data-label="Review">
                                @if($attempt->status == 1 && $exam->exam->end_date <= \Carbon\Carbon::now())
                                    <span>
                                        <a href="{{CustomRoute('training.exam.review',['exam_id'=>$attempt->id,'user_id'=>$user->id,'course_id'=>$exam->course->id,'back_page'=>$back_page])}}" class="badge-blue p-2">Review</a>
                                    </span>
                                @else
                                    <span>----</span>
                                @endif
                            ...
                            <td data-label="Details">
                                @if($attempt->status == 1 && $exam->exam->end_date <= \Carbon\Carbon::now())
                                    <span>
                                        <a href="{{CustomRoute('training.exam.exam_result_details',['user_exams_id'=>$attempt->id,'user_id'=>$user->id,'course_id'=>$exam->course->id,'back_page'=>$back_page])}}" class="badge-red p-2">View Result Details</a>
                                    </span>
                                @else
                                    <span>---- </span>
                                @endif
