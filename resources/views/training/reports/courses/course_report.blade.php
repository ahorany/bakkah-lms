    ...
    <div class="course_info mb-3 card p-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{route('training.coursesReportScorm',['id'=>$course_id,'user_id'=>$user[0]->id??null])}}" class="group_buttons btn-sm {{$active_scorms}}">SCORMS</a>
                {{-- <a href="{{route('training.course_users',['id'=>$course_id,'user_id'=>$user[0]->id??null])}}" class="group_buttons btn-sm">Certificates</a> --}}
                <a href="{{route('training.coursesAssessments',['id'=>$course_id,'user_id'=>$user[0]->id??null])}}" class="group_buttons btn-sm {{$active_assessments}}">Assessments</a>
            </div>
        </div>
    </div>
