...
{{Builder::SetPostType('training-schedule')}}
{{Builder::SetFolder('training-schedule')}}
{{Builder::SetObject('training-schedule')}}
...
<div class="card">
    {{-- <div class="card-header">
        ...
        <div class="float-right d-inline-flex align-items-center justify-content-between">
            {!!Builder::TableAllPosts(0, $statistics->count())!!}
    ...
    <div class="card-body table-responsive p-0">
        {{-- <div id="all_tables" class="row"> --}}
            @include('training.'.$folder.'.course-card', ['coin_id'=>$coin_id])
        {{-- </div> --}}
