        ...
        <tr>
            <td style="direction: ltr; background: #fff; font-weight:300; font-size: 12px; color: #707070; font-family:sans-serif; padding: 0px 35px; line-height: 25px;border: 2px solid #d6d6d6;">
                <div>
                    ...
                    @if (!is_Null($course->trans_title))
                        <div>
                            <span style="color: #fb4400; font-family: -webkit-pictograph;"><strong>Course:</strong></span>
                            <span style="font-family: -webkit-pictograph;">{{$course->trans_title}}</span>
                        </div>
                    @endif
