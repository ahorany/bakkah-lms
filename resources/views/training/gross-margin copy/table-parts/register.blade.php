...
<ul class="list-unstyled m-1">
    @foreach($carts as $cart)
        <li class="mb-2">
            ...
            @endif
            <span class="text-secondary" style="font-size: 16px;"><span>{{$cart->session->trainingOption->training_name??$cart->course->en_name}}</span></span>
            ...
            ?>
            <span class="paid-value badge badge-{{$class[$cart->payment_status]??null}}">
