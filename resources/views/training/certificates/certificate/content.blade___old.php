...
<div style="width: 75%;height: 562px;background-color: #ffffff;float: left;background: url({{CustomAsset('/certificates/img/bg-logo.png')}}) no-repeat;background-size: 130px;background-position: right top;border-bottom: 5px solid #fb4400;position: relative;">
    <div style="text-align: center;">
    <h2 style="font-size: 62px;line-height: 62px;color: #fb4400;margin: 0;padding-top: 80px;">CERTIFICATE</h2>
