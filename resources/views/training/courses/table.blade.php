    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover table-condensed">
            ...
            @foreach($courses as $post)
                <tr data-id="{{$post->id}}">
                    <td><span class="td-title">{{$loop->iteration}}</span></td>
                    <td><span style="display: block;" class="title">{{$post->trans_title ?? null}}</span></td>
                    <td>
                        <span class="td-title">
                            @php
                                $type = [
                    ...
                    <td><span class="td-title">{{$post->code ?? null}}</span></td>
                    <td><span class="td-title">{{$post->category->trans_title ?? null}}</span></td>
                    <td><span class="td-title">{{$post->PDUs ?? null}}</span></td>
                    <td>
                        <?php
                    ...
                    <td><span class="td-title"> {{$completed_learners}} </span></td>
                    <td>
                        <?php
