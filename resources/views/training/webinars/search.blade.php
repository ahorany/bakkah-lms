<style>
    ...
    <form id="post-search" class="form-inline" method="get" action="{{route('training.webinars.index')}}">
            <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="webinar_search"  class="form-control" placeholder="Webinar Title, Video or Zoom Link" value="{{request()->webinar_search}}" class="form-control">
                                    </div>
                                </div>
