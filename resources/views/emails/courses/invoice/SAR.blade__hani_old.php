    ...
    <table align="center" style="width: 600px; padding: 5px 20px;padding-bottom:0;" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td align="center" valign="top" style="background-color: white;border: 2px solid #d6d6d6;border-top: 0;padding: 0px 35px;">
                <table data-id="terms_conditions" cellspacing="0" cellpadding="6" width="600" style="margin-top: 25px;margin-bottom: 15px;padding: 5px;color:#737373;font-size: 12px;" border="0">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #e4e4e4;text-align: right;direction: rtl;font-size: 13px;vertical-align: top;line-height: 18px;">
                            <b>شروط الدفع:</b><br>
                            <span style="color: #fb4400;text-align:right;">
                                        - سجل تجاري رقم 1010061274<br>
                                        - طريقة الدفع: شيك / تحويل بنكي<br>
                                        - تدفع إلى: مؤسسة بكة للتجارة<br>
                                        <span style="float: right;direction: rtl;">- الآيبان:&nbsp;</span> SA2580000653608010528487<br>
                    ...
                    <tr>
                        ...
                        <td width="50%" style="border: 1px solid #e4e4e4;text-align: justify;direction: rtl;font-size: 13px;vertical-align: top">
                            ...
                            <span style="line-height: 25px;">يجب على العميل الراغب فى التدريب عن بعد سداد الفاتورة قبل التدريب بما لايقل عن ساعتين، وفى حال السداد قبل التدريب بأقل من ساعتين فإننا نحتفظ بحقنا فى إلغاء التدريب أو إعادة جدولة التدريب.</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
