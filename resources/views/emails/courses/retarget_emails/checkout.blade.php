    ...
    <tr>
        <td style="width: 600px; background: #fff; font-weight:300; font-size: 12px; color: #707070; font-family:sans-serif; padding: 0px 35px; line-height: 25px">
            {{-- <div style="text-align: center;margin-top: -100px;margin-bottom: 30px;">
                <img width="200" src="{{CustomAsset('images/mail/'.$icon)}}" alt="">
            </div> --}}

            <h2 style="text-align:center;font-weight:bold;font-size: 20px;color: #141414;">Dear <b>{{ $user_name }}</b></h2>
            ...
            <div style="text-align:center;font-size: 18px;color: #141414;">{!! $details !!}</div>
            ...
            <div style="text-align: center;margin-top: 40px">
                {{--<a style="text-decoration: none;background-color: #fb4400;color: #fff;padding: 10px 30px;font-size: 24px;border-radius: 5px;"
