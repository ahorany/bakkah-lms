...
//  This file contains English & Arabic convert from Numbers to Words
// https://www.phpclasses.org/package/7559-PHP-Convert-number-to-Arabic-words.html#information
// Forum for any error or problem
// https://www.phpclasses.org/discuss/package/7559/
// &&&&&&&&&&&&&&& Arabic numbers to words &&&&&&&&&&&&&&&&&&&&&&&&&&&&&
//You need to read the lesson 'Number and numbered' in arabic, to understand this class
// العدد والمعدود

if (!class_exists('convert_ar')) {
    class convert_ar {
...
// &&&&&&&&&&&&&&&  End of Arabic numbers to words &&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
// Two Billion, Two Hundreds Eighty One Million, Nine Hundreds Forty One Thousand and Five Hundr
...
// &&&&&&&&&&&&&&&  End of English numbers to words &&&&&&&&&&&&&&&&&&&&&&&&&&&&&

if(!function_exists('after_num')) {
    function after_num ($this_n, $inthat)
    {
...
if(!function_exists('before_num')) {
    function before_num ($this_n, $inthat)
    {
