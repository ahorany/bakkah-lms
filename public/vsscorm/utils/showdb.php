...
$result = $mysqli -> query("select SCOInstanceID,varName,varValue from scormvars order by SCOInstanceID,varName");
while (list($SCOInstanceID,$varName,$varValue) = $result->fetch_assoc()) {
