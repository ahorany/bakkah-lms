  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , type: {
            email:      "اكتب البريد الالكتروني بصورة صحيحة"
          , url:        "اكتب الرابط بصورة صحيحة"
          , urlstrict:  "This value should be a valid url."
          , number:     "هذا الحقل يجب ان يكون حقل رقم"
          , digits:     "This value should be digits."
          , dateIso:    "This value should be a valid date (YYYY-MM-DD)."
          , alphanum:   "This value should be alphanumeric."
          , phone:      "يجب أن تكون هذه القيمة رقم هاتف صحيح."
        }
      ...
      , range:          "هذا الحقل يجب ان تكون بين %s و %s."
      , minlength:      "هذه القيمة هي قصيرة جدا. وينبغي أن تكون %s حرفا أو أكثر."
      , maxlength:      "هذه القيمة طويلة جدا. وينبغي أن تكون %s حرفا أو أقل."
  ...
  ParsleyField.prototype = {
    ...
    */
    , removeError: function ( constraintName ) {
      ...
      this.options.animate ? $( liError ).hide( this.options.animateDuration, function () {
        $( this ).remove();
