...
tinymce.init({
  selector:"textarea.tinymce",
    ...
    // images_upload_base_path: '/public/upload/tinymce',
    ...
    content_style: "@import url('https://fonts.googleapis.com/css2?family=Lato:wght@100;400&display=swap') ;body { font-family:Helvetica,Arial,sans-serif; font-size:14px }",
    content_css: [
