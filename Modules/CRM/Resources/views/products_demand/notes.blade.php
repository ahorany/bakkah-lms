<div class="card mb-4" id="notes">
    ...
    @push('vue')
        <script>
            // window.notes = {}
            window.notes = {!!json_encode($cartMaster->notes??[])!!}
            var notes = new Vue({
                el:'#notes',
                data:{
                    comment:'',
                ...
                methods: {
                    ...
                    //             axios.get("/api/getNotes/{{$cartMasterId}}")
                    ...
                    addComment: function(){
                        axios.get("{{route('crm::products-demand.comment', $cartMasterId??0)}}", {
                        params:{
                    ...
                    deleteItemsFunc: function() {
                        if(confirm('Are you sure?')) {
                            axios.get("{{route('crm::products-demand.delete', $cartMasterId??0)}}", {
                            params:{
