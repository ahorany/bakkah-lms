                            ...
                            <div class="col-md-3 col-lg-2 col-12 mb-3">
                                <div class="card py-4" style="width: 100%; height:100%; border-radius: 10px; border: 1px solid #d6d6d6; overflow: hidden;">
                                    <div class="row m-0 px-2">
                                        ...
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation done_question">
                                                <label class="m-0 d-block">1</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/green.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation done_question">
                                                <label class="m-0 d-block">2</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/green.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">3</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/red.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">4</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/yellow.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 ">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">5</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/red.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">6</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/green.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation">
                                                <label class="m-0 d-block">7</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/green.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation">
                                                <label class="m-0 d-block">8</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/yellow.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">9</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/green.png')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-4 text-center px-1 mb-2">
                                            <div class="navigation ">
                                                <label class="m-0 d-block">10</label>
                                                <img class="img-fluid" src="{{CustomAsset('/images/red.png')}}" />
                                            </div>
                                        </div>
                                    </div>
