...
class ZoomApiHelper {
    ...
    public static function createZoomMeeting($meetingConfig = []){
		...
		$jwtToken = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOm51bGwsImlzcyI6IllJMFZhdHd6UThLUE55cTIxX3E4ZUEiLCJleHAiOjE2NDAwOTE2MjUsImlhdCI6MTYzOTQ4NzEwNX0.qahmjHScltbyURUpwbMDwxwBguXu3rhtMYeVcd4_9Kw';
		...
		$zoomUserId = 'V-QpjRq7TI-a5-_fl56Htw';
