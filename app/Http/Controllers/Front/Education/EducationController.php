...
class EducationController extends Controller
{
    ...
    public function sessions($category=null){
        ...
        //     $category = explode( '-courses', $category )[0]??$category;
        //     $category_id = Constant::where('post_type', 'course')
        //     ->where('slug', $category)
        //     ->pluck('id');
        //     $category_id = $category_id[0]??null;
        //     if(is_null($category_id)){
        //         return $this->single($category, $method='online-training');
        //     }
        // }
    ...
    public function single($slug=null, $method='online-training'){
        ...
        $relatedArticles = $RelatedHelper->Articles($course->id, 'item_id', 'parent_id');
        // dd($relatedArticles);
        // 'selfCourse'
